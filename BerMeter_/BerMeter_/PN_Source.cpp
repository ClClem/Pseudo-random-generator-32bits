...
PN_Source::PN_Source() {
	...
	_initialState = 0;
	_endState = 0;
	_cycles = 2000; //to modify if we want more cycles of generation
	_cnt = 0;

	_polinomialFunction[0] = 0x2;
	_polinomialFunction[1] = 0x4;
	_polinomialFunction[2] = 0x8;
	_polinomialFunction[3] = 0x16;
	_polinomialFunction[4] = 0x20;
	_polinomialFunction[5] = 0x10;
	_polinomialFunction[6] = 0x70;
	_polinomialFunction[7] = 0x20; //fino qua sono corretti
...
void PN_Source::setState(uint32_t hex) {
	_initialState = hex;
}
